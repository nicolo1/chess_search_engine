        ...
        <div id="user-component-container">
            <Grid container>
                <Grid item xs={2.5}>
                    <img
                        id="user-image"
                        src={user.avatar ? user.avatar : default_icon}
                    />
                </Grid>
                <Grid item xs={7}>
                    <div id="user-details">
                        <span id="user-span-header">
                            {user.username}
                            <Tooltip
                                title={user.country.slice(-2)}
                                placement="top"
                            >
                                <img
                                    crossOrigin="anonymous"
                                    id="user-country-image"
                                    src={getCountry(user.country)}
                                />
                            </Tooltip>
                        </span>
